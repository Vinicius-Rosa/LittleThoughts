...
--
-- Database: `little_thoughts`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `historys`
--
...
INSERT INTO `page` (`id_pag`, `controller`, `method`) VALUES
(1, 'Login', 'index'),
(2, 'Login', 'exeLoginAjax'),
(3, 'home', 'index'),
(4, 'Login', 'logout'),
(5, 'Cadastro', 'index'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `login_user` varchar(16) NOT NULL,
